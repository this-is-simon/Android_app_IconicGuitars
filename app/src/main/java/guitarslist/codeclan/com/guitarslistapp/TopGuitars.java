...
public class TopGuitars  {
    ...
    public void updateBudgetInfoOnGuitars(){
    ...
    private ArrayList<Guitar> getSeed(){
        ...
        guitarImageHashMap.put("Gibson SG", R.drawable.gibson_sg);
        guitarImageHashMap.put("Gibson Explorer", R.drawable.gibson_explorer);
        guitarImageHashMap.put("Gibson ES-335", R.drawable.gibson_es_335);
        guitarImageHashMap.put("Gibson 'Burst' Les Paul", R.drawable.les_paul_burst);
